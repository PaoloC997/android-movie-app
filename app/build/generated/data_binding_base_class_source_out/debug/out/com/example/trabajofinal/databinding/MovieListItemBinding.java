...
public final class MovieListItemBinding implements ViewBinding {
  ...
  private MovieListItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView moviePoster,
  ...
  public static MovieListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MovieListItemBinding((LinearLayout) rootView, moviePoster, movieTitle);
    }
